    ...
    return (
        <>
            <form className='form' onSubmit={registrateUser}>
                ...
                {nameLoginExists && <span style={{color: 'red'}}>Пользователь с таким именем или логином уже существует</span>}
                <span>Ваше имя:</span>
                <input
                    type='text'
                    className='form-name'
                ...
                {!isFormValid && <span style={{color: 'red'}}>Не все поля введены правильно</span>}
